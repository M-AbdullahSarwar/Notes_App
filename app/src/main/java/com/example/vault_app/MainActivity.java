...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tvNumber_of_Notes, tvNumber_of_Del_Notes;
    ...
    protected void onResume() {
        ...
        dataBase.open();
        tvNumber_of_Notes.setText(dataBase.getNumberofNotes() + "");
        tvNumber_of_Del_Notes.setText(dataBase.getNumberofDeletedNotes() + "");
        dataBase.close();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llBin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, Bin.class));
            }
        });
    }
    ...
    private void init() {
        ...
        tvNumber_of_Notes = findViewById(R.id.tvNumber_of_Notes);
        tvNumber_of_Del_Notes = findViewById(R.id.tvNumber_of_Del_Notes);
    }
}